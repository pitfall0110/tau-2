...
// tau/sn66 v20: Docker validator runs use --mode json --no-session -p "<task>".
// Keep this path deterministic and low-overhead by disabling optional resource systems.
function applySolverModeDefaults(parsed: Record<string, any>): void {
...
export async function main(args: string[]) {
        ...
        // tau/sn66 v20: non-interactive solver runs default thinking to off for deterministic behavior.
